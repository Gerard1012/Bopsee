...
@property (nonatomic, strong) UIFont * prenextButtonFont;
@property (nonatomic, strong) UIFont * weekdayFont;
@property (nonatomic, strong) UIFont * titleFont;

// Text color for month and weekday labels
@property (nonatomic, strong) UIColor * monthAndYearTextColor;
...
@property (nonatomic, strong) UIColor * dayTxtColorEvent;
