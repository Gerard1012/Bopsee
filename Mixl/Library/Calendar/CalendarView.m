...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _monthAndYearTextColor      = [UIColor darkGrayColor];
        ...
        _defaultFont                = [UIFont fontWithName:@"HelveticaNeue" size:20.0f];
        _prenextButtonFont          = [UIFont fontWithName:@"HelveticaNeue" size:20.0f];
        _weekdayFont                = [UIFont fontWithName:@"HelveticaNeue" size:15.0f];
        _titleFont                  = [UIFont fontWithName:@"HelveticaNeue" size:20.0f];
        //_titleFont                  = [UIFont fontWithName:@"Helvetica-Bold" size:20.0f];
...
-(void)configureDayButton:(UIButton *)button withDate:(NSDate*)date
{
    ...
    else
    {
        ...
        {
            [button setTitleColor:_dayTxtColorEvent forState:UIControlStateNormal];
...
- (void)drawRect:(CGRect)rect
{
    ...
    [buttonPrev setTitleColor:_monthAndYearTextColor forState:UIControlStateNormal];
    [buttonPrev addTarget:self action:@selector(showPreviousMonth) forControlEvents:UIControlEventTouchUpInside];
    buttonPrev.titleLabel.font          = _prenextButtonFont;
    ...
    [buttonNext setTitleColor:_monthAndYearTextColor forState:UIControlStateNormal];
    [buttonNext addTarget:self action:@selector(showNextMonth) forControlEvents:UIControlEventTouchUpInside];
    buttonNext.titleLabel.font          = _prenextButtonFont;
    ...
    if (!_hideMonthLabel)
    {
        ...
        titleText.textColor             = _monthAndYearTextColor;
    ...
    [_weekDayNames  enumerateObjectsUsingBlock:^(NSString * dayOfWeekString, NSUInteger idx, BOOL *stop)
     {
         ...
         weekNameLabel.text              = [dayOfWeekString uppercaseString];
